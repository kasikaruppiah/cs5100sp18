...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # create a list storing the corner traversal, 1 if visited else 0
        self.cornersState = map(
            lambda corner: 1 if self.startingPosition == corner else 0, self.corners)
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # tuple of position and cornerStates
        return (self.startingPosition, tuple(self.cornersState))
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # return False if any corner is not visited else True
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                nextCornersState = list(state[1])
                if nextPosition in self.corners:
                    # update corner as visited if new position is in corner
                    nextCornersState[self.corners.index(nextPosition)] = 1
                cost = 1  # constant cost 1
                successors.append(
                    ((nextPosition, tuple(nextCornersState)), action, cost))
...
def cornersHeuristic(state, problem):
    ...
    for idx, corner in enumerate(problem.corners):
        if (cornersState[idx] == 0):
            # set the max of old corner cost and current corner cost
            cost = max(cost, util.manhattanDistance(position, corner))
    return cost
...
def foodHeuristic(state, problem):
    ...
    for food in availableFood:
        # set the max of old food cost and current food cost
        cost = max(cost, mazeDistance(
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        # use BFS to find the closest dot
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        availableFood = self.food.asList()
        return (x, y) in availableFood
